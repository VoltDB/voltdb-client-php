...
PHP_FUNCTION(confirm_voltdb_compiled);	/* For testing, remove later. */
...
#ifdef ZTS
#define VOLTDB_G(v) TSRMG(voltdb_globals_id, zend_voltdb_globals *, v)
#else
#define VOLTDB_G(v) (voltdb_globals.v)
#endif
