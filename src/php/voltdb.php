...
class Parameter {
	...
	function __construct($type_or_other=null,$array=null) {
...
class ByteBuffer {
	...
	function get($storage_or_index,$length_or_storage,$length=null) {
		switch (func_num_args()) {
	...
	function put($storage_or_index_or_other,$length_or_storage=null,$length=null) {
		switch (func_num_args()) {
	...
	function putInt8($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function putInt16($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function putInt32($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function putInt64($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function putDouble($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function getString($wasNull_or_index,$wasNull=null) {
		switch (func_num_args()) {
	...
	function putString($value_or_index,$value=null) {
		switch (func_num_args()) {
	...
	function ensureRemaining($remaining) {
		ByteBuffer_ensureRemaining($this->_cPtr,$remaining);
	}

	function ensureRemainingExact($remaining) {
	...
	function ensureCapacityExact($capacity) {
...
abstract class ExpandableByteBuffer extends ByteBuffer {
	...
	function ensureRemaining($amount) {
		ExpandableByteBuffer_ensureRemaining($this->_cPtr,$amount);
	}

	function ensureRemainingExact($amount) {
...
class SharedByteBuffer extends ExpandableByteBuffer {
	...
	function __construct($other_or_data=null,$length=null) {
...
class ScopedByteBuffer extends ExpandableByteBuffer {
	...
	function __construct($capacity_or_data,$length=null) {
...
class Decimal {
	...
	function __construct($txt_or_data=null) {
...
class ParameterSet {
	...
	function addDecimal($val_or_vals) {
	...
	function addTimestamp($val_or_vals) {
	...
	function addDouble($val_or_vals) {
	...
	function addString($val_or_vals) {
...
class InvocationResponse {
	...
	function appStatusString() {
		return InvocationResponse_appStatusString($this->_cPtr);
	}

	function clusterRoundTripTime() {
...
class ClientNative {
	...
	function createConnection($hostname,$port=21212) {
		ClientNative_createConnection($this->_cPtr,$hostname,$port);
	}

	function invoke($proc,$callback=null) {
		switch (func_num_args()) {
...
class Row {
	...
	function getDecimal($column_or_cname) {
	...
	function toString($ostream=null,$indent=null) {
		switch (func_num_args()) {
...
abstract class StatusListenerNative {
	...
	abstract function uncaughtException($exception,$callback,$response);

	abstract function connectionLost($hostname,$connectionsLeft);

	abstract function backpressure($hasBackpressure);
...
class Column {
	...
	function __construct($name_or_type=null,$type=null) {
...
class ConnectionPool {
	...
	function acquireClient($hostname,$username,$password,$port_or_listener=null,$port=null) {
		switch (func_num_args()) {
...
class ClientConfigNative {
	...
	function __construct($username=null,$password=null,$listener=null) {
